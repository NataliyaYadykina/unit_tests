...
import static homework.hw1.Calculator.calculateDiscount;
...
public class CalculatorTest {
    public static void main(String[] args) {
        ...
        // hw1
        assertThat(calculateDiscount(1000, 25)).isEqualTo(750);
        assertThat(calculateDiscount(0, 25)).isEqualTo(0);
        assertThat(calculateDiscount(1000, 0)).isEqualTo(1000);
        assertThat(calculateDiscount(0, 0)).isEqualTo(0);
        assertThat(calculateDiscount(-1000, 10)).isEqualTo(900);
        assertThat(calculateDiscount(1000, -10)).isEqualTo(900);
        assertThat(calculateDiscount(-100, -10)).isEqualTo(90);
